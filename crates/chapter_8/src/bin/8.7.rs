...
fn main() -> Result<(), io::Error> {
    ...
    let mut close_exec_flag =
        fcntl::fcntl(dir.as_raw_fd(), FcntlArg::F_GETFD).expect("fcntl failed");
    println!(
    ...
    close_exec_flag = fcntl::fcntl(dir.as_raw_fd(), FcntlArg::F_GETFD).expect("fcntl failed");
    println!(
